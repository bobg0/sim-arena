# Sim-Arena Developer Guide

**Internal developer documentation** for the `sim-arena` codebase. For user-facing instructions, see [GENERAL_README.md](GENERAL_README.md).

This guide covers setup, training, benchmarks, distributed operations, and codebase architecture.
